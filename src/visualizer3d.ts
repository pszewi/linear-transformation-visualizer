...
// ─── Colour palette ──────────────────────────────────────────────────────────
const COL_CUBE_ORIG  = 0x444466;
const COL_CUBE_TRANS = 0x3a7bd5;
const COL_E1_BEFORE  = 0x884444;
const COL_E1_AFTER   = 0xff4444;
const COL_E2_BEFORE  = 0x448844;
const COL_E2_AFTER   = 0x44ff44;
const COL_E3_BEFORE  = 0x444488;
const COL_E3_AFTER   = 0x4444ff;
...
export class Visualizer3D {
  ...
  private _buildScene() {
    ...
    // axis labels
    const lx = makeTextSprite('x', '#ff6666'); lx.position.set(1.6, 0, 0);
    const ly = makeTextSprite('y', '#66ff66'); ly.position.set(0, 1.6, 0);
    const lz = makeTextSprite('z', '#6666ff'); lz.position.set(0, 0, 1.6);
